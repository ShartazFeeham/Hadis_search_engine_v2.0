package hadis.searchengine.v2.static_data_server.server;
        ...
        public class HadisProcessor {
            ...
            public Map<?, ?> process() {
                ...
                LOGGER.info("Data retrieved from staticRepo: {}", data);
                return singleProcess(data);
            }

            private Map<?, ?> batchProcess(Map<String, String> data) {
                LOGGER.info("Starting batchProcess method");
                ...
                LOGGER.info("Batch process completed. Total success time: {}, Total fail time: {}", totalSuccessTime, totalFailTime);
                return Map.of(
            ...
            private Map<?, ?> singleProcess(Map<String, String> data) {
                LOGGER.info("Starting singleProcess method");
                long id = 1;
                ...
                LOGGER.info("Single process completed. Success count: {}, Fail count: {}", successCount, failCount);
                return Map.of(
            ...
            private Note generateNote(long id, String key, String value) {
                LOGGER.debug("Generating note for key: {}, value: {}", key, value);
                return Note.builder()
                        .noteId(id)
                        .tag(key)
            ...
            private @NonNull Map<String, Object> generateKeywords(String key, String value) {
                LOGGER.debug("Generating keywords for key: {}", key);
            ...
            private @NonNull List<String> getBreadCrumbBn(String key) {
                LOGGER.debug("Generating Bengali breadcrumb for key: {}", key);
            ...
            private String getBnNumber(String engNum) {
                LOGGER.debug("Converting English number to Bengali: {}", engNum);
            ...
            private @NonNull List<String> getBreadCrumbEn(String key) {
                LOGGER.debug("Generating English breadcrumb for key: {}", key);
                String book = switch (key.substring(0, key.indexOf("-"))) {
